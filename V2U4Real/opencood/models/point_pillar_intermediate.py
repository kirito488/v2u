...
class PointPillarIntermediate(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        spatial_features_2d_ego = batch_dict.get('spatial_features_2d_ego', spatial_features_2d)
        ...
        output_dict = {'psm': psm,
                       'rm': rm,
                       'Z_fused': spatial_features_2d,
                       'Z_ego': spatial_features_2d_ego}
        self._defense_z = {
            'Z_fused': spatial_features_2d.detach(),
            'Z_ego': spatial_features_2d_ego.detach(),
        }
