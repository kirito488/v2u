...
class PointPillarWhere2comm(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        # MADE Z: fused feature vs ego-only slice at the same tensor the cls_head sees.
        cum_sum_len = torch.cumsum(record_len, dim=0)
        split_2d = torch.tensor_split(spatial_features_2d, cum_sum_len[:-1].cpu())
        z_ego = torch.stack([xx[0] for xx in split_2d], dim=0)

        output_dict = {
            'psm': psm, 'rm': rm, 'com': communication_rates,
