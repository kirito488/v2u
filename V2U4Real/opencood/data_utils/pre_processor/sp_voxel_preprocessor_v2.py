# -*- coding: utf-8 -*-
# Author: WeiJia Li <vjiali@stu.xmu.edu.cn>
# License: MIT
...
class SpVoxelPreprocessorV2(BasePreprocessor):
    def __init__(self, preprocess_params, train):
        super(SpVoxelPreprocessorV2, self).__init__(preprocess_params,
                                                  train)
        self.spconv = 1
        try:
            # spconv v1.x
    ...
    def preprocess(self, pcd_np, cav_id):
        data_dict = {}
        if self.spconv == 1:
        ...
        if cav_id == 1:
            data_dict['agent_type'] = 'vehicle'
        elif cav_id == 2:
            data_dict['agent_type'] = 'uav'
