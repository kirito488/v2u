...
from opencood.data_utils.pre_processor.sp_voxel_preprocessor_v2 import SpVoxelPreprocessorV2
...
__all__ = {
    ...
    'SpVoxelPreprocessorV2': SpVoxelPreprocessorV2
}
...
def build_preprocessor(preprocess_cfg, train):
    ...
    assert process_method_name in ['BasePreprocessor', 'VoxelPreprocessor',
                                   'BevPreprocessor', 'SpVoxelPreprocessor', 'SpVoxelPreprocessorV2'], \
        error_message
